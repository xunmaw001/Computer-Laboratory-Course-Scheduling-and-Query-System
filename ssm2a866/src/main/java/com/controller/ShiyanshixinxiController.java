...
public class ShiyanshixinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		shiyanshixinxi.setClicknum(shiyanshixinxi.getClicknum()+1);
		shiyanshixinxi.setClicktime(new Date());
		shiyanshixinxiService.updateById(shiyanshixinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ShiyanshixinxiEntity shiyanshixinxi, HttpServletRequest request,String pre){
        EntityWrapper<ShiyanshixinxiEntity> ew = new EntityWrapper<ShiyanshixinxiEntity>();
