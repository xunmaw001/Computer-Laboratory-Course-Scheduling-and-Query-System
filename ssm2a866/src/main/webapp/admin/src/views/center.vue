  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="工龄" prop="gongling">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.nianling)&& 'xuesheng'==this.flag){
      ...
      if((!this.ruleForm.nianling)&& 'jiaoshi'==this.flag){
        this.$message.error('年龄不能为空');
        return
      }
      ...
      if((!this.ruleForm.gongling)&& 'jiaoshi'==this.flag){
        this.$message.error('工龄不能为空');
        return
      }
      if((!this.ruleForm.shouji)&& 'jiaoshi'==this.flag){
