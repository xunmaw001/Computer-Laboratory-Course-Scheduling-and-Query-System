    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报修内容" prop="baoxiuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiuneirong" label="报修内容" prop="baoxiuneirong">
                    <span v-html="ruleForm.baoxiuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baoxiuneirong = this.ruleForm.baoxiuneirong.replace(reg,'../../../ssm2a866/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
