<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.shiyanbaogao" label="实验报告" prop="shiyanbaogao">
          <file-upload
          tip="点击上传实验报告"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.shiyanbaogao?ruleForm.shiyanbaogao:''"
          @change="shiyanbaogaoUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shiyanbaogao" label="实验报告" prop="shiyanbaogao">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.shiyanbaogao.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="实验内容" prop="shiyanneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shiyanneirong" label="实验内容" prop="shiyanneirong">
                    <span v-html="ruleForm.shiyanneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.kaikeshijian = this.getCurDateTime()
  ...
  methods: {
	...
	this.ruleForm.shiyanneirong = this.ruleForm.shiyanneirong.replace(reg,'../../../ssm2a866/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    shiyanbaogaoUploadChange(fileUrls) {
	this.ruleForm.shiyanbaogao = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
