    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实验室类型" prop="shiyanshileixing">
          <el-input v-model="ruleForm.shiyanshileixing" 
              placeholder="实验室类型" clearable  :readonly="ro.shiyanshileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实验室类型" prop="shiyanshileixing">
              <el-input v-model="ruleForm.shiyanshileixing" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm2a866/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
