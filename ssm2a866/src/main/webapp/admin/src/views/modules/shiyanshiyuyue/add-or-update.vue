    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="预约原因" prop="yuyueyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yuyueyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuyueyuanyin" label="预约原因" prop="yuyueyuanyin">
                    <span v-html="ruleForm.yuyueyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yuyueyuanyin = this.ruleForm.yuyueyuanyin.replace(reg,'../../../ssm2a866/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
